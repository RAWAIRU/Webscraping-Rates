#########################
# Achmea Bank - Centraal Beheer Label
...
source('functions/productRateAB.R')
source('settings/settingsABCentraalBeheer.R')
...
for (productNum in 1:numberofProducts) {
    ...
    dfRates[productNum,4] <-  productRateAB(tempUrl,tempDur,scaleFactor)
