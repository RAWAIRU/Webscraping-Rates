...
source('functions/productRateYapiKredi.R')
source('settings/settingsYapiKredi.R')
...
for (productNum in 1:numberofProducts) {
  ...
  dfRates[productNum,4] <-  productRateYapiKredi(tempUrl,tempNod,tempNod2,scaleFactor)
